...
def test_client_async() -> None:
    async def test_body() -> str:
        ...
        async with EditTools(MOCK_PROJ_PATH, WebsocketClient(PORT, HOST)) as tools:
            ...
            await sub_test('#12', 'create_file', {'target_path': 'edit_hello.txt', 'content': 'Hello world!\n\tHello world!\nHello world!\n'})
            await sub_test('#13', 'create_file', {'target_path': 'edit_hello.txt', 'content': 'Hello world!\n\tHello world!\nHello world!\n\tHello world!\nHello world!\n'})
