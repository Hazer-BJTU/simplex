...
parser.add_argument('--generator_lr', type=float, nargs='?', default=1e-4, help='learning rate for GAN')
...
parser.add_argument('--n_generator', type=int, nargs='?', default=5, help='number of generator steps per epoch')
